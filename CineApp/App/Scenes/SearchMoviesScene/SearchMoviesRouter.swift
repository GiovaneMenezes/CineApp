...
protocol SearchMoviesRouterInput {
    
}

protocol SearchMoviesRouterDataSource: class {
    var selectedMovie: MovieResult? { get }
}

protocol SearchMoviesRouterDataDestination: class {
...
class SearchMoviesRouter: SearchMoviesRouterInput {
    ...
    weak private var dataSource: SearchMoviesRouterDataSource!
    weak var dataDestination: SearchMoviesRouterDataDestination!
    
    enum SegueIdentifier: String {
        case movieDetail = "MovieDetail"
    }
    
    init(viewController: SearchMoviesViewController, dataSource: SearchMoviesRouterDataSource, dataDestination: SearchMoviesRouterDataDestination) {
